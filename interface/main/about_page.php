        ...
        <div class="row">
            <div class="col-xs-12 col-md-4 col-md-offset-4 text-center">
                <div class="page-header">
                    <h1><?php echo xlt("About");?>&nbsp;HealthQuilt EMR</h1>
                </div>
                ...
                <?php } ?>-->
				<span class="text"><?php echo xlt("Support Phone Number : "); ?> 346-406-1730</span><br>
				<span class="text"><a href="https://www.healthquilt.com/" target="_blank"> <?php echo xlt("HealthQuilt Group "); ?> </a> </span><br>
				<span class="text"><a href="../../acknowledge_license_cert.html"  target="_blank"<span class="text"<?php echo xlt('HealthQuilt Group'); ?>> </a></span>
